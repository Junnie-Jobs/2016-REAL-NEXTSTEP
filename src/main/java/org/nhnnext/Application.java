...
import org.nhnnext.repository.SessionRepository;
...
public class Application {
	...
	public CommandLineRunner demo(LectureRepository lectureRepository, UserRepository userRepository,
			CourseRepository courseRepository, SessionRepository sessionRepository, SecurityUserRepository securityUserRepository) {
		return (args) -> {
